...
if __name__ == '__main__':
  ...
  input_csv_        = "RollingStoneData.csv" 
  color_bkgd_       = "white"
  color_border_     = "black"
  color_dot_        = "orange"
  dot_size_         = 4
  ...
  plot_title = "Bands Featured on Rolling Stone's \"40 Greatest Emo Albums of All Time\""
  ...
  add_duplicates_textbox(monocolor_ax, bandDupes, initialText="> 1 Albums: ", bump=True)

  # here we plot with with a color scale 
  colorscale_col = "Year released"
  colorscale_label = "Year Album Released"
  ...
  add_duplicates_textbox(colorscale_ax, bandDupes, initialText="> 1 Albums: ", bump=True)
